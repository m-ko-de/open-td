...
export class FrostTower extends BaseTower {
  ...
  protected createSprite(): void {
    ...
    // Main tower body (cyan/frost blue)
    this.sprite.fillStyle(0x00ddff, 1);
    this.sprite.fillRoundedRect(-12, -8, 24, 18, 3);
    
    // Darker shade for depth
    this.sprite.fillStyle(0x0099bb, 1);
